...
Players can opt specific players into instant request acceptance with `/tpautoaccept`.
Instant acceptance is controlled by the `simpletpa:allow_instant_tpa_accepting` gamerule, which is enabled by default.
